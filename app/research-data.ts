...
{id:5,title:"Self-Refine: Iterative Refinement with Self-Feedback",topic:"自我纠错",venue:"NeurIPS",year:"2023",summary:"围绕生成、反馈和修改的循环探索输出改进。",method:"自反馈迭代",limitation:"需区分任务类型与反馈有效性。",url:"https://arxiv.org/abs/2303.17651",saved:true,read:false,source:"agent",sourceDetail:"Agent 主题检索"},
{id:6,title:"Reflexion: Language Agents with Verbal Reinforcement Learning",topic:"自我纠错",venue:"NeurIPS",year:"2023",summary:"利用反馈与语言反思支持后续尝试。",method:"语言反思与记忆",limitation:"需核查反馈来源与环境假设。",url:"https://arxiv.org/abs/2303.11366",saved:true,read:false,source:"radar",sourceDetail:"科研雷达发现"},
{id:7,title:"Least-to-Most Prompting Enables Complex Reasoning in Large Language Models",topic:"推理机制",venue:"ICLR",year:"2023",summary:"将复杂问题拆解为一系列较小子问题，并逐步组合中间答案。",method:"由简到繁问题分解",limitation:"分解质量与任务结构会直接影响最终结果。",url:"https://arxiv.org/abs/2205.10625",saved:true,read:true,source:"agent",sourceDetail:"Agent 引用扩展"},
{id:8,title:"STaR: Bootstrapping Reasoning With Reasoning",topic:"推理机制",venue:"NeurIPS",year:"2022",summary:"通过生成与筛选推理过程迭代改进模型的推理能力。",method:"推理轨迹自举训练",limitation:"需要核查筛选策略造成的偏差与覆盖范围。",url:"https://arxiv.org/abs/2203.14465",saved:true,read:false,source:"upload",sourceDetail:"用户上传 PDF"},
{id:9,title:"Large Language Monkeys: Scaling Inference Compute with Repeated Sampling",topic:"多路径推理",venue:"arXiv",year:"2024",summary:"研究增加推理时采样规模对复杂任务成功率和计算成本的影响。",method:"重复采样与最优答案选择",limitation:"性能增益依赖可靠验证器并带来较高推理成本。",url:"https://arxiv.org/abs/2407.21787",saved:true,read:false,source:"radar",sourceDetail:"科研雷达发现"},
{id:10,title:"Solving Math Word Problems With Process- and Outcome-Based Feedback",topic:"过程监督",venue:"arXiv",year:"2023",summary:"系统比较过程反馈与结果反馈对数学推理训练的影响。",method:"过程反馈与结果反馈对照",limitation:"结论主要来自数学任务，跨领域泛化仍需验证。",url:"https://arxiv.org/abs/2211.14275",saved:true,read:true,source:"agent",sourceDetail:"Agent 主题检索"},
{id:11,title:"Math-Shepherd: Verify and Reinforce LLMs Step-by-step without Human Annotations",topic:"过程监督",venue:"ACL",year:"2024",summary:"通过自动过程监督构造步骤级奖励信号并强化数学推理。",method:"自动过程奖励模型",limitation:"自动标注噪声和验证器偏差需要原文核查。",url:"https://arxiv.org/abs/2312.08935",saved:true,read:false,source:"link",sourceDetail:"arXiv 链接"},
{id:12,title:"CRITIC: Large Language Models Can Self-Correct with Tool-Interactive Critiquing",topic:"自我纠错",venue:"ICLR",year:"2024",summary:"利用外部工具反馈帮助模型检查并修正自身输出。",method:"工具交互式批判与修正",limitation:"效果依赖工具可用性、反馈质量与调用成本。",url:"https://arxiv.org/abs/2305.11738",saved:true,read:false,source:"radar",sourceDetail:"科研雷达发现"}
];
